    ...
    private void seedProperties() {
        List<Property> properties = Arrays.asList(
                ...
                Property.builder()
                        ...
                        .developer("One5 Realty Group")
                        .status("Premium")
                        .tags(Arrays.asList("Mathura", "Vrindavan", "Holy Location", "Luxury Living"))
                        .img("https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?w=800&q=80")
                        .pdf("/projects/hanumant-vihar.pdf")
                        .description("Experience spiritual tranquility at Hanumant Vihar. Located on the Radha Kund-Ral Road in Vrindavan, Mathura, this project offers premium plots in a divine setting.")
                ...
                Property.builder()
                        ...
                        .listingType("Projects")
                        .type("Residential Plot")
                        .title("Shree Krishna Green Valley")
                        .price(1800000L)
                        .priceStr("₹18 L - ₹50 L")
                        .area("100 - 300 sq yards")
                        ...
                        .developer("One5 Realty Group")
                        .status("New Launch")
                        .tags(Arrays.asList("Mathura", "Yamuna Expressway", "Braj Corridor"))
                        .img("https://images.unsplash.com/photo-1582268611958-ebfd161ef9cf?w=800&q=80")
                        .pdf("/projects/hanumant-vihar.pdf")
                        ...
                        .amenities(Arrays.asList("Expressway Access", "24/7 Security", "Wide Blacktop Roads", "Green Parks"))
                        .build(),
                Property.builder()
                        .id("proj_rka")
                        .cityId("mathura")
                        .listingType("Projects")
                        .type("Residential Plot")
                        .title("Radhe Krishna Ashrama")
                        .price(2000000L)
                        .priceStr("₹20 L - ₹55 L")
                        .area("100 - 350 sq yards")
                        .location("Village Devi Aatas, Teh. Sadar, Vrindavan (Mathura)")
                        .developer("One5 Realty Group")
                        .status("New Launch")
                        .tags(Arrays.asList("Mathura", "Vrindavan", "Devi Aatas", "Spiritual Living"))
                        .img("https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&q=80")
                        .pdf("/projects/radhe-krishna-ashrama.pdf")
                        ...
                        .amenities(Arrays.asList("Temple Proximity", "24/7 Security", "Wide Blacktop Roads", "Gated Community", "Lush Parks"))
                        .build(),
                Property.builder()
                        .id("proj_rkp")
                        .cityId("mathura")
                        .listingType("Projects")
                        .type("Residential Plot")
                        .title("Radha Krishnapuram")
                        .price(2200000L)
                        .priceStr("₹22 L - ₹65 L")
                        .area("120 - 400 sq yards")
                        .location("Near Shri Baba Law College at Vill Semari, On NH-2 Highway, Mathura (UP)")
                        .developer("One5 Realty Group")
                        .status("New Launch")
                        .tags(Arrays.asList("Mathura", "NH-2 Highway", "Semari", "Highway Touch"))
                        .img("https://images.unsplash.com/photo-1510798831971-661eb04b3739?w=800&q=80")
